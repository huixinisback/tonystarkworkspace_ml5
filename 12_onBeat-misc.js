...
let songPlay, songAnalyse, fft, peak;
let started = false;
let startSong;
...
function setup() {
    ...
    fft = new p5.FFT();
    peak = new p5.PeakDetect(20, 20000, 0.1, 20);  // (freqLow, freqHigh, threshold, framesPerPeak)
    songAnalyse.setVolume(0.1);   
...
function draw(){
    ...
    console.log("Peak:", peak.isDetected, "Energy:", fft.getEnergy("bass"));
